/**
 * PAI Theme for Remotion — mirrors structure-of-atom + kinematics + oscillations.
 * Adds chemistry-specific atom palette for VSEPR scene.
 */
...
export const PAI_THEME = {
  colors: {
    ...
    hydrogen: '#fbbf24',   // soft yellow (visible on dark bg)
    oxygen: '#dc2626',     // red
