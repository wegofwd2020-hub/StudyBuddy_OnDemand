/**
 * PAI Theme for Remotion — mirrors kinematics + oscillations + g9 + structure-of-atom + basic-chem themes.
 * Adds chemistry-specific particle palette plus thermodynamic curve colours.
 */
...
export const PAI_THEME = {
  colors: {
    ...
    // Thermo-specific
    reactant: '#f87171',     // soft red
    product: '#34d399',      // green
    transitionState: '#fbbf24',  // amber
    energyCurve: '#fb7185',   // pink-red bell curve
  },
