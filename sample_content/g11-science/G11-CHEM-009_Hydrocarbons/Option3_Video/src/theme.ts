/**
 * PAI Theme — Hydrocarbons / Markovnikov scene.
 * Mirrors the chemistry theme from G11-CHEM-008 and G10-SCI-004 so
 * the atom palette + bond conventions stay consistent across the
...
export const PAI_THEME = {
  colors: {
    ...
    bromine: '#a16207',    // amber-brown for Br
    bond: '#cbd5e1',       // bond stick
    lonePair: '#a78bfa',   // lone-pair cloud (purple)

    // Functional-group / mechanism highlight
    fgHighlight: '#facc15',     // attention yellow — "this is the bit to watch"
    chargePos: '#ef4444',       // red for + charge
    chargeNeg: '#3b82f6',       // blue for - charge
    arrow: '#a78bfa',           // curly arrow — accent purple
    dashedReject: '#64748b',    // muted slate for the rejected alternative
  },
