...
/**
 * Slide 12 — Call to action / end slate
 *
 * Mirrors the teacher-story end card so both videos close on the same
 * brand mark + tagline + two CTA pills. Pulse animation + sustained
 * caption hold for ~16s.
 */
export const Slide12_CallToAction: React.FC = () => {
  ...
  const ctaOpacity = interpolate(frame, [60, 100], [0, 1], {
  ...
  return (
    <SceneFrame
      ...
      caption="Try it tonight — demo.studybuddy.app — or have your school reach out to support@studybuddy.app."
    >
      <AbsoluteFill
        style={{
          alignItems: "center",
