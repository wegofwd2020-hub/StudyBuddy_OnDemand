 ...
 */
export const Slide02_MeetDaniel: React.FC = () => {
  ...
  return (
    <SceneFrame
      ...
      caption="Meet Daniel — Grade 11 Science. Tonight he's working through photosynthesis on his laptop."
    >
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", gap: 80, flexDirection: "row" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24, opacity: cardFade }}>
          <div
            style={{
              ...
              height: 200,
              borderRadius: "50%",
              backgroundColor: PAI_THEME.colors.dim3,
              ...
              boxShadow: `0 0 60px ${PAI_THEME.colors.dim3}66`,
            }}
          >
            DM
          </div>
        ...
        >
          ...
          <h2 style={{ margin: "0 0 18px 0", color: PAI_THEME.colors.text, fontSize: 44, fontWeight: 700, fontFamily: PAI_THEME.typography.fontFamily }}>
            <TypeInText text="Photosynthesis" cps={28} startAt={50} />
          </h2>
          <p
            style={{
              margin: 0,
