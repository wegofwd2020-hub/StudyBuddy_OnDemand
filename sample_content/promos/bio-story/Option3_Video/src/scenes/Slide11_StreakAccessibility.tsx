 ...
 *
 * Daniel finishes her lesson. The streak counter ticks 7 → 8 with a
...
export const Slide11_StreakAccessibility: React.FC = () => {
  ...
  return (
    <SceneFrame
      ...
      caption="He finishes the unit. Eleven nights of biology in a row — the streak counter knows."
    >
      <AbsoluteFill
        style={{
          alignItems: "center",
