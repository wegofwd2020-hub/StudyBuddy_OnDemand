 ...
 * active tile highlighted. Cursor moves to the active tile + clicks
...
export const Slide03_Dashboard: React.FC = () => {
  ...
  return (
    <SceneFrame
      ...
      caption="Daniel opens her dashboard. Continue where you left off — Photosynthesis is queued and ready."
    >
      <div style={{ position: "absolute", inset: 0, opacity: fadeIn }}>
        <AppFrame userName="Daniel M." clockTime="9:14 PM">
          <DashboardPage
