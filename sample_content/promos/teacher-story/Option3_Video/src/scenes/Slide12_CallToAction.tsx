 ...
 *
 * Visual: brand mark + tagline springs in. Two CTA pills appear with a
 * subtle pulse animation. The frame holds for the full ~16-second
 * caption duration to give viewers time to read or scan.
 */
export const Slide12_CallToAction: React.FC = () => {
  ...
  const pulse = (frame % 60) / 60; // 0..1 over 2 seconds
