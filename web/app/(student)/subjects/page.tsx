      ...
      <div className="max-w-5xl space-y-6 p-6">
        <div className="space-y-1">
          ...
          <p className="text-sm text-gray-500">
            Browse every subject and open a lesson or quiz. The Curriculum Map
            lays out every unit in order, so you can see what you&apos;ve passed,
            what you&apos;re part-way through, and what comes next.
          </p>
        </div>
