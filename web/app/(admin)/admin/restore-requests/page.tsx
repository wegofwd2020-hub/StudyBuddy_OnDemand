    ...
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Restore Requests</h1>
          <span className="ml-2 text-sm text-gray-500">({requests.length} total)</span>
        </div>
        <button
          onClick={load}
      ...
      {loading ? (
        <div className="py-12 text-center text-gray-500">Loading restore requests…</div>
      ) : requests.length === 0 ? (
        <div className="py-12 text-center text-gray-500">No restore requests found.</div>
      ) : (
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50 text-left">
                <th className="border-b px-4 py-2 font-medium text-gray-700">School</th>
