  ...
  if (!isAdmin) {
    return (
      <div className="max-w-2xl p-6">
        <h1 className="mb-3 text-2xl font-bold text-gray-900">Teacher Management</h1>
        <p className="text-sm text-gray-500">
          Only school administrators can manage teachers. Contact your school admin to
          invite new teachers.
        </p>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl space-y-6 p-6">
      <div className="flex items-center gap-2">
        ...
        <Badge className="ml-1 border-purple-100 bg-purple-50 text-purple-700">
          Admin only
        </Badge>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          {successEmail && (
            <div className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 p-3 text-sm text-green-700">
              ...
              Invitation sent to <span className="font-medium">{successEmail}</span>. They
              will receive an Auth0 login link.
            </div>
          )}
              ...
              <tbody className="divide-y divide-gray-50">
                {invited.map((t) => (
                  <tr key={t.teacher_id}>
                    ...
                    <td className="px-4 py-3">
                      <Badge className="border-blue-100 bg-blue-50 text-xs text-blue-700">
                        Invited
                      </Badge>
                    </td>
                  </tr>
      ...
      <Card className="border bg-gray-50 shadow-sm">
        <CardContent className="p-4">
          <p className="text-xs text-gray-500">
            Invited teachers receive an Auth0 link to set up their account. Once they sign
            in, they can access class reports and student progress. To change a
            teacher&apos;s role or deactivate their account, contact platform support.
          </p>
        </CardContent>
      </Card>
    </div>
