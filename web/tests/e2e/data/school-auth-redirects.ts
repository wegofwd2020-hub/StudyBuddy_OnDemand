...
export const SCHOOL_PROTECTED_ROUTES: ReadonlyArray<{
  ...
  {
    tcId: "SCH-AUX-01",
    path: "/school/class/class-001",
    description: "Class overview (dynamic route)",
  },
  {
    tcId: "SCH-AUX-02",
    path: "/school/student/student-001",
    description: "Student detail (dynamic route)",
  },
  ...
  {
    tcId: "SCH-AUX-07",
    path: "/school/reports/engagement",
