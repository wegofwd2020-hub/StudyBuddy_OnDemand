...
export const MOCK_STUDENT_STATS: StudentStats = {
  ...
  subject_breakdown: [
    { subject: "Science", attempts: 6, pass_rate: 0.83, current: true },
    { subject: "Mathematics", attempts: 4, pass_rate: 0.75, current: true },
    { subject: "English", attempts: 2, pass_rate: 0.5, current: true },
  ],
};
