  ...
  subjects: [
    {
      subject: "Mathematics",
      units: [
        { unit_id: "G8-MATH-001", title: "Linear Equations",             subject: "Mathematics", grade: 8, sort_order: 1, has_lab: false },
        { unit_id: "G8-MATH-002", title: "Quadratic Functions",           subject: "Mathematics", grade: 8, sort_order: 2, has_lab: false },
        { unit_id: "G8-MATH-003", title: "Geometry: Pythagorean Theorem", subject: "Mathematics", grade: 8, sort_order: 3, has_lab: false },
      ],
    },
    {
      subject: "Science",
      units: [
        { unit_id: "G8-SCI-001", title: "Cell Biology",        subject: "Science", grade: 8, sort_order: 1, has_lab: true  },
        { unit_id: "G8-SCI-002", title: "Chemical Reactions",  subject: "Science", grade: 8, sort_order: 2, has_lab: true  },
        { unit_id: "G8-SCI-003", title: "Forces and Motion",   subject: "Science", grade: 8, sort_order: 3, has_lab: false },
      ],
    },
  ],
};
...
export const MOCK_PROGRESS_WITH_STATUS: ProgressHistory = {
  ...
  unit_progress: [
    ...
    { unit_id: "G8-SCI-002",  status: "in_progress",  best_score: null, attempts: 1, last_attempted_at: "2026-03-23T09:00:00Z" },
